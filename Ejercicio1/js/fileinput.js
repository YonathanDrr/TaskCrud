...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-default btn-sm waves-effect waves-light',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn btn-default btn-sm waves-effect waves-light',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-sm waves-effect waves-light',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn btn-default btn-sm waves-effect waves-light',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadExtraData: {},
